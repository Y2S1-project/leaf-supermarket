...
List<Product> products = pd.getCategoryProducts(9);
%>
...
<body>
	...
	<div class="container">
		<div class="card-header my-3"><center>Food Cupboard</center></div>
		<div class="category-head"><img src="images/foodCupboard-banner.jpeg" alt="fruit banner"></div>
		<div class="row">
		<%
			if(!products.isEmpty()) {
