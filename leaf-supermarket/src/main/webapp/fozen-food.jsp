...
List<Product> products = pd.getCategoryProducts(4);
%>
...
<body>
	...
	<div class="container">
		<div class="card-header my-3"><center>Frozen Food</center></div>
		<div class="category-head"><img src="images/frozenFood-banner.jpeg" alt="fruit banner"></div>
		<div class="row">
		<%
			if(!products.isEmpty()) {
