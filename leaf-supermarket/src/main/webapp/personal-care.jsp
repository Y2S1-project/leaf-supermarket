...
List<Product> products = pd.getCategoryProducts(10);
%>
...
<body>
	...
	<div class="container">
		<div class="card-header my-3"><center>Personal Care Products</center></div>
		<div class="category-head"><img src="images/selfCare-banner.jpeg" alt="fruit banner"></div>
		<div class="row">
		<%
			if(!products.isEmpty()) {
