...
List<Product> products = pd.getCategoryProducts(7);
%>
...
<body>
	...
	<div class="container">
		<div class="card-header my-3"><center>Pharmacy</center></div>
		<div class="category-head"><img src="images/pharmacy-banner.jpeg" alt="fruit banner"></div>
		<div class="row">
		<%
			if(!products.isEmpty()) {
