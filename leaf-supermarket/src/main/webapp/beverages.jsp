...
List<Product> products = pd.getCategoryProducts(5);
%>
...
<body>
	...
	<div class="container">
		<div class="card-header my-3"><center>Beverages</center></div>
		<div class="category-head"><img src="images/beverages-banner.jpeg" alt="fruit banner"></div>
		<div class="row">
		<%
			if(!products.isEmpty()) {
